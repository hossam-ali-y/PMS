...
?>
         		  <form class = "w3-container" role = "form" action="<?php echo  $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data"  method="post">
                    <tr>
						<td>
							<span class="custom-checkbox">
								<input id="checkbox<?php echo $r['id']?>" name="options[]" value="<?php echo $r['id']?>" type="checkbox">
								<label for="checkbox<?php echo $r['id']?>"></label>
							</span>
						</td>
                        <td><?php echo $r['id']?></td>
                        <!--td><?php
					...
					<img  class="w3-col" src="../images/avatar.png?>" alt="no photo" title="<?php echo $r['username']?> hasn't profile" style="width:50px;border-radius:50%"> 
						...
						<td><?php echo $r['lng']?></td>				
						 <td><?php echo $r['start_date']?></td>
						  <td><?php echo $r['finish_date']?></td>
						   <td><?php echo $r['status']?></td>
                        <td>
						 <a href="#editEmployeeModal"  onclick="
<?php
//$get_uid="document.getElementById('getuid').value";
   $sql11="select * from projects where id=".$r['id'];
   $res=$db->query($sql11);	 
?>  
		...
		<div class="modal-dialog">
			<div class="modal-content">
					...
					<div class="modal-body">					
						<p>Are you sure you want to delete user -<?php echo $r['name']?>- ?</p>
						<p class="text-warning"><small>cancle to undelete</small></p>
					</div>
					  <form class = "w3-container" role = "form" action="<?php echo  $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data"  method="post">
                  
					<div class="modal-footer">
					<input   name="u_name" value="<?php echo $r['name'];?>" type="hidden">
